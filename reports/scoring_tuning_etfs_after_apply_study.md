# Scoring Tuning Study - ETFs After Apply
...
| --- | --- |
| Control | 11.14 |
| Faster ETF recovery | 10.79 |
| Balanced ETF trend | 10.48 |
| More defensive slow trend | 6.68 |

Ganadora de la iteracion: `etf_trend_control` con `aggregate_score=11.14`.
...
Ganadora de la iteracion: `etf_support_control` con `aggregate_score=11.14`.
...
| etf_support | Control | etfs_equity_broad | Balanced fixed 20d | 1.11 | 1.0 | 1.82 | 1.93 | 1.86 | 74 | 44 | 23.81 |
...
| etf_trend | Control | etfs_equity_broad | Balanced fixed 20d | 1.11 | 1.0 | 1.82 | 1.93 | 1.86 | 74 | 44 | 23.81 |
| etf_trend | Balanced ETF trend | etfs_equity_broad | Balanced fixed 20d | 1.27 | 0.94 | 2.01 | 1.85 | 1.88 | 72 | 43 | 22.91 |
| etf_trend | Faster ETF recovery | etfs_equity_broad | Balanced fixed 20d | 1.16 | 0.94 | 1.88 | 1.85 | 1.88 | 73 | 43 | 22.41 |
| etf_trend | More defensive slow trend | etfs_equity_broad | Balanced fixed 20d | 1.11 | 0.77 | 1.76 | 1.64 | 2.07 | 71 | 43 | 17.47 |
| etf_trend | Faster ETF recovery | etfs_defensive_bonds | Balanced fixed 10d | -0.35 | -0.35 | 0.24 | 0.25 | 1.06 | 121 | 48 | -16.34 |
